            ...
            <div className={styles.main}>
              {ev.coverImage?.url && (
                <div className={styles.cover}>
                  <Image src={ev.coverImage.url} alt={ev.coverImage.alt || `${ev.title} — Anita Prajapat live Jagran in ${ev.city || siteConfig.city}`} title={ev.title} fill priority fetchPriority="high" sizes="66vw" />
                </div>
              )}
