...
export const siteConfig = {
  ...
  description:
    "Official website of Anita Prajapat (अनीता प्रजापत) — female Rajasthani bhajan singer from Jaipur known for Sanwariya Seth, Khatu Shyam, Mataji, Balaji & Satguru bhajans and live Jagran across India. New bhajans every week on YouTube.",
  city: "Jaipur",
  ...
  // Genre list is keyword-verified: each entry maps to demand confirmed via
  // Search Console queries, Google autosuggest, or her own top-viewed YouTube
  // videos (e.g. Satguru bhajan = her #1 video; Balaji bhajan = top cluster).
  genres: [
  ...
  // Verified organic keywords — sources: GSC queries (sawariya/Devanagari
  // variants), Google autosuggest (booking intent: singer/fees/female), and
  // YouTube tag data. Devanagari included because GSC shows Hindi-script
  // queries already surfacing the site.
  keywords: [
    "Anita Prajapat",
    "Singer Anita Prajapat",
    "Anita Prajapat ke Bhajan",
    "अनीता प्रजापत",
    "Sanwariya Seth Bhajan",
    ...
    "Female Rajasthani Bhajan Singer",
    "Balaji Bhajan Rajasthani",
    "Satguru Bhajan",
    "Mataji Bhajan Singer",
    "Marwadi Bhajan",
    "Jagran Singer",
    "Live Jagran Singer Jaipur",
    "Bhajan Singer in Jaipur",
    "Female Bhajan Singer Jaipur",
