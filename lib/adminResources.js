...
export const resourceConfigs = {
  events: {
    ...
    fields: [
      ...
      { name: "type", label: "Type", type: "select", options: ["jagran", "concert", "private", "temple", "other"] },
  ...
  gallery: {
    ...
    fields: [
      ...
      { name: "image", label: "Photo", type: "image", folder: "gallery" },
      { name: "isFeatured", label: "Featured", type: "boolean" },
  ...
  banners: {
    ...
    fields: [
      ...
      { name: "placement", label: "Placement", type: "select", options: ["hero", "promo", "section"] },
  ...
  categories: {
    ...
    fields: [
      { name: "name", label: "Name", type: "text", required: true },
      { name: "type", label: "Type", type: "select", options: ["bhajan", "blog", "event", "gallery", "general"] },
      { name: "description", label: "Description", type: "textarea", full: true },
      { name: "order", label: "Order", type: "number" },
      { name: "isActive", label: "Active", type: "boolean" },
    ],
  ...
  media: {
    ...
    fields: [
      ...
      { name: "type", label: "Type", type: "select", options: ["news", "article", "interview", "press", "video"] },
