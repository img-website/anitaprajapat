...
export const resourceConfigs = {
  ...
  events: {
    ...
    view: {
      ...
      metaRender: (i) => i.date ? fmtDate(i.date) + (i.startTime ? ` · ${i.startTime}` : "") : "",
      quickToggles: [],
    },
    columns: [
  ...
  inquiries: {
    ...
    columns: [
      ...
      { key: "type", label: "Type" },
      {
        ...
        label: "Status",
        render: (i) => {
          const color = STATUS_COLORS[i.status] || "var(--text-muted)";
          return (
            <span style={{
              display: "inline-flex",
      ...
      { key: "createdAt", label: "Received", render: (i) => fmtDateTime(i.createdAt) },
    ],
    fields: [
